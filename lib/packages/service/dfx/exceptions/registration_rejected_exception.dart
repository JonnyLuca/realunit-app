...
/// Auth (401/403) and rate-limit (429) responses, 5xx, transport errors, an
/// 'Invalid signature' rejection, and failures of any other call stay plain
/// [ApiException]s — for those, that instruction would be wrong.
